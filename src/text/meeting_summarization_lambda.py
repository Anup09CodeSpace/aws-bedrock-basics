...
# API Gateway. It reads the instruction fed by the user. 
# The function generates meeting summary based on the input 
# meeting notes. 
###############################################################
...
#Function to extract text from a multipart meeting notes
...
#Function to invoke model Anthropic model and generate meeting summary
...
#Function for save meeting notes to S3 bucket
